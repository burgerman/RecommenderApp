...
import com.group7.recommenderapp.ui.movie.RecommendationFragment.OnListFragmentInteractionListener;
...
//    MovieItem item = results.get(position).item;
    ...
    holder.recommendationMovieTitleView.setText(item.getTitle() + " - " + item.getGenres());
        ...
        new View.OnClickListener() {
          ...
          public void onClick(View v) {
            if (null != listener) {
              ...
              listener.onClickRecommendedMovie((MovieItem)item);
            }
          }
        });
  }
